...
urlpatterns: List[URLPattern] = [
    ...
    path(
        "project/<str:slug>/upload/",
        VersionUploadView.as_view(),
        name="version--upload",
    ),
    path(
    ...
    path(
        "project/<str:project_slug>/<str:version>/",
        VersionDetailView.as_view(),
        name="version--detail",
    ),
    path(
        "project/<str:project_slug>/<str:version>/delete/",
...
urlpatterns += ClassifierViewSet(
    url_prefix="lookups", url_namespace=app_name
).get_urlpatterns()
